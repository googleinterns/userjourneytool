...
def test_compute_single_node_status_already_set():
    ...
    assert ujt.compute_status.compute_single_node_status(
        node_name_message_map,
        node_name) == Status.STATUS_HEALTHY
...
def test_compute_single_node_status_with_sli(
        sli_value,
        expected_status,
        slo_bounds):
    node_name = "node"
...
def test_compute_status_from_count_map(count_map, expected_status):
    assert ujt.compute_status.compute_status_from_count_map(
        count_map) == expected_status
