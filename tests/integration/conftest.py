...
def replace_canvas_percy_snapshot(started_dash_duo, snapshot_name):
    ...
    node_canvas = started_dash_duo.driver.find_element_by_css_selector("[data-id=layer2-node]")
    ...
    started_dash_duo.driver.execute_script(replace_canvas_with_image_script, node_canvas)
